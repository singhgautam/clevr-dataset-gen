...
parser.add_argument('--output_image_dir', default='../output_3_to_8_mirror_test/images/',
    help="The directory where output images will be stored. It will be " +
         "created if it does not exist.")
parser.add_argument('--output_scene_dir', default='../output_3_to_8_mirror_test/scenes/',
    help="The directory where output JSON scene structures will be stored. " +
         "It will be created if it does not exist.")
parser.add_argument('--output_scene_file', default='../output_3_to_8_mirror_test/CLEVR_scenes.json',
