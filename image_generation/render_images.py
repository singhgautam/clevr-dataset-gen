...
parser.add_argument('--output_image_dir', default='/research/projects/object_centric/gs790/idalle/datasets/clevrmetal-with-masks-004-biased-set-red-color-only/images/',
    help="The directory where output images will be stored. It will be " +
         "created if it does not exist.")
parser.add_argument('--output_scene_dir', default='/research/projects/object_centric/gs790/idalle/datasets/clevrmetal-with-masks-004-biased-set-red-color-only/scenes/',
    help="The directory where output JSON scene structures will be stored. " +
         "It will be created if it does not exist.")
parser.add_argument('--output_scene_file', default='/research/projects/object_centric/gs790/idalle/datasets/clevrmetal-with-masks-004-biased-set-red-color-only/CLEVR_scenes.json',
