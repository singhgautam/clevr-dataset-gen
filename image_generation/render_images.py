...
parser.add_argument('--min_dist', default=6.0, type=float,
...
parser.add_argument('--output_image_dir', default='/research/projects/object_centric/gs790/idalle/datasets/clevr-gso-001/images/',
    help="The directory where output images will be stored. It will be " +
         "created if it does not exist.")
parser.add_argument('--output_scene_dir', default='/research/projects/object_centric/gs790/idalle/datasets/clevr-gso-001/scenes/',
    help="The directory where output JSON scene structures will be stored. " +
         "It will be created if it does not exist.")
parser.add_argument('--output_scene_file', default='/research/projects/object_centric/gs790/idalle/datasets/clevr-gso-001/CLEVR_scenes.json',
...
def add_random_objects(scene_struct, num_objects, args, camera):
  ...
  for i in range(num_objects):
    ...
    # size_name, r = "null", (0.5 + random.random())
