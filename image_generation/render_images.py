...
parser.add_argument('--output_image_dir', default='/data/local/gs790/idalle/datasets/clevrmetal-with-masks-003-correlated-training-set/images/',
    help="The directory where output images will be stored. It will be " +
         "created if it does not exist.")
parser.add_argument('--output_scene_dir', default='/data/local/gs790/idalle/datasets/clevrmetal-with-masks-003-correlated-training-set/scenes/',
    help="The directory where output JSON scene structures will be stored. " +
         "It will be created if it does not exist.")
parser.add_argument('--output_scene_file', default='/data/local/gs790/idalle/datasets/clevrmetal-with-masks-003-correlated-training-set/CLEVR_scenes.json',
